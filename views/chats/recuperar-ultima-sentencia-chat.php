...
<?php foreach ($chat as $sentencia): ?>
    <?php if ($sentencia["username"] != $username): ?>
        <b> <?php echo $sentencia["username"]; ?> <?php echo " (" . Html::encode($puntaje) . " puntos)"; ?> - <span style="color:#005C53;"><?php echo Html::encode($rangoNombre)  ?></span></b><br/>
    ...
    elseif (preg_match('/^\/debate (\d+)\s+(.+)$/', $sentencia["sentencia"], $matches)): 
        ...
        <div class="respuesta-debate">
            ...
            <?= $esProfesor ? 
                Html::button('Valorar Opinión. Otorgará 100 puntos.', [
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert('No se pudo puntuar la respuesta.');
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert('No se pudo valorar la opinión.');
                }
            }
        });
    });
