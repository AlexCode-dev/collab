...
$this->title = 'Crear Actividad Gamificada';
...
<div class="container d-flex flex-column align-items-center justify-content-center" style="min-height: 100vh;">
    <div class="text-center">
        ...
        <p class="text-secondary">Selecciona el tipo de actividad para comenzar a diseñar tu experiencia interactiva.</p>
    </div>
            ...
            <?= Html::a(
                '<div class="card shadow-sm h-100 hover-card">
                    <div class="card-body d-flex justify-content-center align-items-center">
                        <img src="' . Yii::$app->request->baseUrl . '/images/iconos/individual.png" class="card-icon" alt="Icono Individual">
                    </div>
                    <div class="card-footer text-center">
                        <h5 class="text-primary">Actividad Individual</h5>
                        <p class="text-description">Cada miembro debe realizar su parte de manera independiente. Se califica de forma Independiente.</p>
                    </div>
                </div>',
                ['create', 'asigid' => $asigid, 'tipoactividad' => $tipoIndividual],
        ...
        <div class="col-md-4">
            <?= Html::a(
                '<div class="card shadow-sm h-100 hover-card">
                    ...
                    <div class="card-footer text-center">
                        <h5 class="text-primary">Actividad Grupal</h5>
                        <p class="text-description">Todos los miembros deben trabajar juntos para alcanzar un objetivo común. Se califica de forma GRUPAL.</p>
                    </div>
                </div>',
